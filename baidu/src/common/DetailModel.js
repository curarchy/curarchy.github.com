...
define(
    function (require) {
         ...
         * @type {string}
         */
        DetailModel.prototype.treeEntityType = '';
         ...
         * @return {string}
         */
        DetailModel.prototype.getTreeDatasourceURL = function () {
            return '/' + this.treeEntityType + '/tree';
        };
        ...
        DetailModel.prototype.getTreeDatasource = function () {
            var loading = this.data.request(
                this.treeEntityType + '/tree',
                null,
                {
                    method: 'GET',
                    url: '/' + u.pluralize(this.treeEntityType) + '/tree'
                }
            );
            return loading.then(u.bind(this.buildTreeDatasource, this));
        };

        /**
         * 子实体的类型列表，一个类型会对应一个TAB页
         *
         * @type {string[]}
         */
        DetailModel.prototype.childEntityTypes = [];
