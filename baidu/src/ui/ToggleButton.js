...
define(
    function (require) {
        ...
        function getPartHTML(button, part) {
            var id = helper.getId(button, part);
            var classes = 
                helper.getPartClasses(button, 'part-' + part).join(' ');
            var html = 
                '<span id="' + id + '" class="' + classes + '"></span>';
            return html;
        }
         ...
         * @protected
         */
        ToggleButton.prototype.repaint = helper.createRepaint(
