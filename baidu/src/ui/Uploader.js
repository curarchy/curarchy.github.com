...
define(
    function (require) {
        ...
        Uploader.prototype.initStructure = function () {
            ...
            this.callbackName = helper.getGUID('esuiShowUploadResult');
            ...
            },
            {
                ...
                paint: function (uploader, rawValue) {
                    ...
                    if (!rawValue.hasOwnProperty('type')) {
                        ...
                        rawValue.type = FILE_TYPES[options.info.type];
                    }
        ...
        Uploader.prototype.showUploadResult = function (options) {
            ...
            if (options.fields) {
                ...
                else if (typeof options.info.type === 'number') {
                    options.info.type = FILE_TYPES[options.info.type];
                }
        ...
        Uploader.prototype.getPreviewURL = function () {
            return this.fileInfo ? this.fileInfo.previewURL : '';
        };
